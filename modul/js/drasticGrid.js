...
var drasticGrid = new Class ({
	...
	refresh: function() {
		...
		var url = t.options.path+'?op=v&start='+start+'&end='+end+'&cols='+t.columnnames+'&sortcol='+t.options.sortcol+'&sort='+t.options.sort+t.options.addparams;
		t.showLoading();
		var myajax = new Request({
			url: url,
			method: 'get',
